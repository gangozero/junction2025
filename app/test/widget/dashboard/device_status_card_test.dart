      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            deviceStateProvider(
              'test-device-1',
            ).overrideWith((ref) async => mockDevice),
          ],
          child: MaterialApp(
            home: Scaffold(
                body: DeviceStatusCard(deviceId: mockDevice.deviceId)),
          ),
        ),
      );
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            deviceStateProvider(
              'test-device-2',
            ).overrideWith((ref) async => offlineDevice),
          ],
          child: MaterialApp(
            home: Scaffold(
                body: DeviceStatusCard(deviceId: offlineDevice.deviceId)),
          ),
        ),
      );
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            deviceStateProvider(
              'test-device-3',
            ).overrideWith((ref) async => noTempDevice),
          ],
          child: MaterialApp(
            home:
                Scaffold(body: DeviceStatusCard(deviceId: noTempDevice.deviceId)),
          ),
        ),
      );
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            deviceStateProvider(
              'test-device-4',
            ).overrideWith((ref) async => powerOffDevice),
          ],
          child: MaterialApp(
            home: Scaffold(
                body: DeviceStatusCard(deviceId: powerOffDevice.deviceId)),
          ),
        ),
      );
      await tester.pumpAndSettle();
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            deviceStateProvider(
              'test-device-1',
            ).overrideWith((ref) async => updatedDevice),
          ],
          child: MaterialApp(
            home: Scaffold(
                body: DeviceStatusCard(deviceId: mockDevice.deviceId)),
